...
training_positive_path = base_path.joinpath('./HumanBehavior/2017/train/positive_examples_anonymous_chunks')
training_negative_path = base_path.joinpath('./HumanBehavior/2017/train/negative_examples_anonymous_chunks')
test_path = base_path.joinpath('./HumanBehavior/2017/test')
...
with open("tokens.pk","rb") as file:
